...
public class Player extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button lag = (Button) findViewById(R.id.lag);
      final  Button controlButton = (Button) findViewById(R.id.control);
      final Button  sync = (Button) findViewById(R.id.sync);
       final  Button seekForwardButton = (Button) findViewById(R.id.seekForward);
       final  Button seekBackwardButton = (Button) findViewById(R.id.seekBackward);
